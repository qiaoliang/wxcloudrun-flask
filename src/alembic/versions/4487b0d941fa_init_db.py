...
Revision ID: 4487b0d941fa
Revises: 
Create Date: 2025-12-08 19:21:45.949725
...
def upgrade():
    ...
    op.create_index('idx_share_log_token', 'share_link_access_logs', ['token'], unique=False)
    ...
    op.create_index('idx_audit_action', 'user_audit_logs', ['action'], unique=False)
    ...
    op.create_index('idx_verif_phone_purpose', 'verification_codes', ['phone_number', 'purpose'], unique=False)
    ...
    op.create_index('idx_checkin_rules_solo_user', 'checkin_rules', ['solo_user_id'], unique=False)
    op.create_index('idx_checkin_rules_status', 'checkin_rules', ['status'], unique=False)
    ...
    op.create_index('idx_checkin_records_planned_time', 'checkin_records', ['planned_time'], unique=False)
    op.create_index('idx_checkin_records_rule', 'checkin_records', ['rule_id'], unique=False)
    op.create_index('idx_checkin_records_solo_user', 'checkin_records', ['solo_user_id'], unique=False)
    ...
    op.create_index('idx_share_solo_rule', 'share_links', ['solo_user_id', 'rule_id'], unique=False)
    op.create_index('idx_share_token', 'share_links', ['token'], unique=False)
    ...
    op.create_index('idx_solo_supervisor', 'supervision_rule_relations', ['solo_user_id', 'supervisor_user_id'], unique=False)
    op.create_index('idx_supervisor_rule', 'supervision_rule_relations', ['supervisor_user_id', 'rule_id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_supervisor_rule', table_name='supervision_rule_relations')
    op.drop_index('idx_solo_supervisor', table_name='supervision_rule_relations')
    op.drop_table('supervision_rule_relations')
    op.drop_index('idx_share_token', table_name='share_links')
    op.drop_index('idx_share_solo_rule', table_name='share_links')
    op.drop_table('share_links')
    op.drop_index('idx_checkin_records_solo_user', table_name='checkin_records')
    op.drop_index('idx_checkin_records_rule', table_name='checkin_records')
    op.drop_index('idx_checkin_records_planned_time', table_name='checkin_records')
    op.drop_table('checkin_records')
    op.drop_index('idx_checkin_rules_status', table_name='checkin_rules')
    op.drop_index('idx_checkin_rules_solo_user', table_name='checkin_rules')
    op.drop_table('checkin_rules')
    op.drop_index('idx_verif_phone_purpose', table_name='verification_codes')
    ...
    op.drop_table('users')
    op.drop_index('idx_audit_user', table_name='user_audit_logs')
    op.drop_index('idx_audit_action', table_name='user_audit_logs')
    op.drop_table('user_audit_logs')
    op.drop_index('idx_share_log_token', table_name='share_link_access_logs')
