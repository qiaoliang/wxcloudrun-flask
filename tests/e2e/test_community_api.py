...
class TestCommunityAPI:
    ...
    def test_create_community_success(self, base_url):
        """测试成功创建社区"""
        base_url = base_url
    ...
    def test_create_community_without_name(self, base_url):
        """测试缺少社区名称时的错误处理"""
        base_url = base_url
    ...
    def test_create_community_without_location(self, base_url):
        """测试缺少社区位置时的错误处理"""
        base_url = base_url
    ...
    def test_create_community_name_too_short(self, base_url):
        """测试社区名称太短时的错误处理"""
        base_url = base_url
    ...
    def test_create_community_name_too_long(self, base_url):
        """测试社区名称太长时的错误处理"""
        base_url = base_url
    ...
    def test_create_community_description_too_long(self, base_url):
        """测试社区描述太长时的错误处理"""
        base_url = base_url
    ...
    def test_create_community_without_permission(self, base_url):
        """测试普通用户尝试创建社区时的权限错误"""
        base_url = base_url
    ...
    def test_create_community_minimal_data(self, base_url):
    ...
    def test_create_duplicate_community_name(self, base_url):
        """测试创建重复名称的社区"""
        base_url = base_url
