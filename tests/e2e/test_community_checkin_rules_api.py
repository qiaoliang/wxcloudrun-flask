...
class TestCommunityCheckinRulesAPI:
    ...
    def test_get_rules_requires_authentication(self, base_url):
        """测试获取规则列表需要认证"""
        base_url = base_url
    ...
    def test_get_rules_requires_community_permission(self, base_url):
        """测试获取规则列表需要社区管理权限"""
        base_url = base_url
    ...
    def test_create_and_get_rules_workflow(self, base_url):
        """测试完整的规则创建和获取流程"""
        # 创建社区和社区管理员
    ...
    def test_update_rule(self, base_url):
        """测试修改规则"""
        base_url = base_url
        # 先创建一个规则
    ...
    def test_enable_and_disable_rule(self, base_url):
        """测试启用和停用规则"""
        base_url = base_url
        # 先创建一个规则
        header,commu,a_new_rule= self._create_header_and_commu_and_a_rule(base_url)
    ...
    def test_cannot_update_enabled_rule(self, base_url):
        """测试不能修改已启用的规则"""
        base_url = base_url
    ...
    def test_delete_rule(self, base_url):
        base_url = base_url
    ...
    def test_cannot_delete_enabled_rule(self, base_url):
        """测试不能删除已启用的规则"""
        base_url = base_url
    ...
    def test_get_rules_with_include_disabled(self, base_url):
        """测试获取规则列表时包含已禁用的规则"""
        base_url = base_url
        header, comm, a_rule = self._create_header_and_commu_and_a_rule(base_url)
    ...
    def test_create_rule_successfully(self, base_url):
        base_url = base_url
        auth_headers, commu=self._create_community_and_admin_headers(base_url)
    ...
    def test_rule_detail_permission(self, base_url):
        """测试规则详情的权限控制"""
        base_url = base_url
        auth_headers, commu = self._create_community_and_admin_headers(base_url)
        ...
        # 使用现有的方法创建规则
        header, commu_created, a_rule = self._create_header_and_commu_and_a_rule(base_url, rule_data)
        rule_id = a_rule['community_rule_id']
